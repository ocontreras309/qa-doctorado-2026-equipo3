...
- Defensa aplicada: `ci/run_gate_gaming_drill.py (función __main__)`, `ci/gate_integrity_baseline.txt`
...
- Extender el gate con criterios más orientados a riesgo (sin aumentar ruido) y afinar el valor del Jaccard score para mayor robustez de la evaluación de las respuestas del chatbot.
